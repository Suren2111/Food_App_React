...
const RestuarantCards=(props)=>{
    ...
    return(
            <div className="mx-8 p-4 w-80 bg-white shadow-lg rounded-lg hover:scale-105 hover:shadow-xl transition-transform duration-300  dark:bg-gray-800 text-black dark:text-white">
              <Link to={"/restuarantcards/"+id}><img  className="w-full h-48 object-cover rounded-lg" src={obj_harcoded.CDN_URL+cloudinaryImageId} alt="Restuarant Image" />
